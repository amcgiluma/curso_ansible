  ...
  return (
    <div className="my-4 overflow-hidden rounded-xl border border-ink-600 bg-ink-800/80">
      <div className="flex items-center justify-between border-b border-ink-600 bg-ink-700/50 px-3 py-1.5">
        <span className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-ansible-300">
          <span className="inline-block h-2 w-2 rounded-full bg-ansible-400" />
          Comando
        </span>
