      ...
      >
        <div className="border-b border-ink-600 p-5">
          <NavLink to="/" onClick={onClose} className="flex items-center gap-3">
            <span className="text-2xl font-black text-ansible-300">A</span>
            <div>
              <p className="font-extrabold leading-tight text-white">
                Curso de Ansible
              </p>
              <p className="text-xs text-slate-400">Proxmox, Docker y homelab</p>
            </div>
          </NavLink>
          ...
          <div className="mt-4">
            ...
            <div className="h-2 overflow-hidden rounded-full bg-ink-700">
              <div
                className="h-full rounded-full bg-gradient-to-r from-ansible-500 to-ansible-300 transition-all"
                style={{ width: `${pct}%` }}
              />
            </div>
          </div>
