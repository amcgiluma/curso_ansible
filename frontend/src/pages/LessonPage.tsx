      ...
      <div className="mt-10 flex items-center justify-between border-t border-ink-600 pt-5">
        <button
          ...
          className={`rounded-lg px-4 py-2 text-sm font-semibold transition ${
              ...
              : "border border-ink-600 bg-ink-700/60 text-slate-200 hover:border-ansible-500"
          }`}
        >
      ...
      <nav className="mt-6 flex justify-between gap-4 text-sm">
        {prev ? (
          <Link
            ...
            className="rounded-lg border border-ink-600 px-4 py-3 text-slate-300 transition hover:border-ansible-500 hover:text-white"
          >
            ← {prev.title}
          </Link>
        ) : (
        ...
        {next ? (
          <Link
            ...
            className="rounded-lg border border-ink-600 px-4 py-3 text-right text-slate-300 transition hover:border-ansible-500 hover:text-white"
          >
            {next.title} →
          </Link>
        ) : (
